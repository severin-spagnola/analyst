      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-16">
        <header className="flex items-center justify-between py-6">
          <div className="flex items-center gap-3">
            <div className="rounded-2xl bg-gradient-to-br from-purple-500 to-cyan-400 p-2 shadow-lg shadow-purple-900/30">
    ...
    <div className="space-y-8">
      <Card className="border-white/10 bg-white/5">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <button
            className="rounded-full bg-gradient-to-r from-purple-500 to-cyan-400 px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-purple-900/40 transition hover:shadow-purple-700/40"
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <MetricCard label="Total Scans" value={metrics.totalScans} helper="Last 30 days" accent="from-purple-500 to-blue-500" />
        <MetricCard
        ...
        <MetricCard label="Overall Risk Score" value={`${metrics.overallRisk}%`} helper="Weighted by severity" accent="from-amber-400 to-purple-500" />
      </div>
        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                className="rounded-full bg-gradient-to-r from-purple-500 to-cyan-400 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-purple-900/40 transition hover:shadow-purple-700/50"
                onClick={onEnter}
              >
                Go to Dashboard
              </button>
              <button
                className="rounded-full border border-white/15 px-5 py-3 text-sm font-semibold text-white backdrop-blur hover:bg-white/5"
                onClick={onEnter}
              >
                View mock data
              </button>
          ...
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-purple-600/30 via-blue-500/25 to-cyan-400/20 p-1">
      ...
      {tabs.map((tab) => (
        <button
          ...
          className={`rounded-full border px-4 py-2 text-sm font-semibold transition ${
            activeTab === tab.key
              ? 'border-white/70 bg-white/15 text-white shadow-lg shadow-purple-900/30'
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/5 p-3 sm:flex-row sm:items-center">
          ...
          <button
            onClick={onStartScan}
            className="w-full rounded-xl bg-gradient-to-r from-purple-500 to-cyan-400 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-purple-900/40 transition hover:shadow-purple-700/40 sm:w-auto"
          >
            New Scan
          </button>
        </div>
          ...
          return (
            <button
              ...
              className={`rounded-full border px-3 py-2 text-xs font-semibold transition ${
                selected
                  ? 'border-white/60 bg-white/20 text-white shadow-lg shadow-purple-900/30'
                  : 'border-white/10 bg-white/5 text-slate-200 hover:border-white/30'
              }`}
            >
              {tool}
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="h-2 w-40 overflow-hidden rounded-full bg-white/10">
                <div
                  className="h-full rounded-full bg-gradient-to-r from-purple-400 to-cyan-300 transition-all"
      ...
      <div className="space-y-3">
        ...
        {!loadingData &&
          Object.entries(groupedFindings).map(([host, items]) => {
            ...
            return (
              <Card key={host} className="border-white/10 bg-white/5">
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div>
                    <h4 className="text-lg font-semibold text-white">{host}</h4>
                    <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-slate-300">
                      <span className="rounded-full border border-white/10 bg-white/5 px-2 py-1">{items.length} issues</span>
                  ...
                  <button
                    ...
                    className="rounded-full border border-white/10 px-3 py-1 text-xs font-semibold text-white hover:border-white/30"
                  >
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="border-white/10 bg-white/5">
          <h4 className="text-sm font-semibold uppercase tracking-wide text-slate-300">Issues by severity</h4>
          <div className="mt-4 space-y-3">
            {loadingData &&
            ...
            {!loadingData &&
              (Object.entries(severityStats) as [Severity, number][]).map(([severity, count]) => (
                <div key={severity} className="flex items-center gap-3 text-sm text-white">
        ...
        <Card className="border-white/10 bg-white/5">
          <h4 className="text-sm font-semibold uppercase tracking-wide text-slate-300">Issues by tool</h4>
          <div className="mt-4 space-y-3">
            {loadingData &&
            ...
            {!loadingData &&
              (Object.entries(toolStats) as [ScanTool, number][]).map(([tool, count]) => (
                <div key={tool} className="flex items-center gap-3 text-sm text-white">
                  <span className="min-w-[88px] rounded-full border border-white/10 bg-white/5 px-3 py-1 text-center text-xs font-semibold text-slate-200">
                    {tool}
                  </span>
                  <div className="h-2 flex-1 rounded-full bg-white/10">
                    <div
      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 p-4 lg:col-span-3">
        ...
        <div className="mt-4 flex flex-col gap-3">
          ...
          <form onSubmit={onSendMessage} className="flex flex-col gap-2 sm:flex-row">
            ...
            <button
              type="submit"
              className="min-w-[120px] self-end rounded-xl bg-gradient-to-r from-purple-500 to-cyan-400 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-purple-900/40 transition hover:shadow-purple-700/50"
            >
              Send
            </button>
          </form>
